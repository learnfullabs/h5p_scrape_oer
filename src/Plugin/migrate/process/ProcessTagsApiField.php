...
/**
 * Provides a 'ProcessTagsApiField' migrate process plugin.
 *
 * @MigrateProcessPlugin(
 *  id = "process_tags_api_field"
 * )
 */
class ProcessTagsApiField extends ProcessPluginBase {
  ...
  public function transform($value, MigrateExecutableInterface $migrate_executable, Row $row, $destination_property) {
  	$tagsItem = $row->getSourceProperty("tags");
